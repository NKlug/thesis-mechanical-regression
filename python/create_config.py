...
def create_configs(s, r, h, mu, ls_regularizer, log_base_dir, checkpoint_base_dir):
    for s1, r1, h1, mu1, ls_regularizer1 in product(s, r, h, mu, ls_regularizer):
        ...
        create_config(name, s=s1, r=r1, h=h1, mu=mu1, ls_reg=ls_regularizer1, log_base_dir=log_base_dir,
