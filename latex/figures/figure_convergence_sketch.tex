\begin{figure}
	\makebox[\textwidth][c]{
		...
		\begin{tikzpicture}[font=\scriptsize, align=center]
				\node[draw, above left, align=center, text width=77mm, minimum height=20mm] (a) {
					ResNet \ref{prob:discrete-resnet}\\
					$\begin{cases}
				...
				\node[draw, right= of z1, align=center,text width=75mm, minimum height=20mm] (b) {
				...
				\node[draw, below= of z2, align=center, text width=77mm, minimum height=25mm] (c) {
				...
				\node[right=of c, align=center,outer sep=-2em] (z4) {\large$\stackrel{L \rightarrow \infty}{\longrightarrow}$\\
					\scriptsize\cref{theo:problem-convergence}};
				\node[draw, below= of z3, right=of z4, align=center, text width=75mm, minimum height=25mm] (d) {
				...
				\node[draw, below= of z5, align=center, text width=75mm, minimum height=25mm] (e) {
				...
				\node[draw, below= of z6, align=center, text width=77mm, minimum height=25mm] (f) {
	...
	\caption{Summary of problems, their correspondence, their continuous limits and the respective theorems. Discrete problems are on the left, continuous problems on the right.}
