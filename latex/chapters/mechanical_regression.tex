...
For our calculations we will therefore only assume that $l$ is a positive, continuous loss function.
...
\begin{problem}
	...
	\end{cases}
\end{problem}
\Todo{Explain what it means for problems to be equivalent! We probably want bijection between minimizers and same optimal values.}
