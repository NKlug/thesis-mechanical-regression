...
\Todo{Hint: Figure XY gives an overview of all problems.
Also: Simplified Model of ResNet, as real architectures map different spaces}
...
\Todo{bGamma(X, X) is the block operator matrix with entries Gamma(Xi, Xj)}
\begin{condition}
