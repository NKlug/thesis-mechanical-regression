...
\Todo{Adam was used for optimization}
...
The plot at $(\mu=0.03, t=1)$ of great interest, as it is not in line with the other plots, which at $t=1$ mostly show monotonously decreasing space deformation.
