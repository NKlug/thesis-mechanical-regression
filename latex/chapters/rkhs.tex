...
Using this notation, we can rewrite \autoref{eq:optimal-recovery-f} as
\begin{equation}
...
\begin{align}
	\norm{f}_\mathcal{H} &= \left< f, f\right>_\mathcal{H}\\
...
Ridge regression can be seen as a Tikhonov-regularized variant of optimal recovery with multiplication by a constant.