...
The equivalence of the continuous least action \ref{prob:cont-least-action} and the geodesic shooting formulation \ref{prob:geodesic-shooting} can also be derived for the discrete case.
